...
cjbart_custom <- function(data, Y, type = NULL, id = NULL, round = NULL, use_round = TRUE, cores = 1, ...) {
  ...
  if (.Platform$OS.type=='unix') {
    ...
    #' *Original Code --> use mc.pbart() if system == UNIX*
    # if (type == "choice") {
    ...
    #' *Changed Code --> use pbart() if system == UNIX  (as on non UNIX systems)*
