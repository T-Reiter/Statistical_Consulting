...
@image-panel depicts 4 decision trees that were fitted to better understand how different subject level covariates contribute to the observed effect heterogeneity. These exemplary decision trees were selected regarding content and interpretation and to highlight how single decision tress can be utilized for model interpretation.  
